(function ($) {
    $.fn.temporizador = function (opcoes) {
        ...
        let temporizador = setInterval(() => {
            ...
            const diferencaEmMilisec = alvo.getTime() - agora.getTime()

            if (diferencaEmMilisec >= 0) {
                const diferenca = regex.exec(new Date(diferencaEmMilisec).toISOString())
                ...
                // hora chegou, para de monitorar temporizador
